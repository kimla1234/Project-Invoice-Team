    ...
    return [...apiClients] 
      ...
      .filter((c) => {
        ...
        const matchesGender =
          ...
          selectedGenders.includes(c.gender === "MALE" ? "Male" : "Female");
  ...
  return (
    <div className="w-full space-y-4">
      <div className="rounded-[10px] border bg-white dark:border-dark-3 dark:bg-gray-dark">
        <Table>
          <TableHeader className="border-none bg-[#F7F9FC] dark:bg-dark-2">
            <TableRow>
              {visibleColumns.ID && (
